      ...
      <div className="p-4">
        <div className="mx-auto max-w-2xl flex flex-col gap-3 pb-8">
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4 px-3.5 pb-3.5">
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-3.5 px-3.5 pb-3.5">
              <div className="flex items-center justify-between">
                <div>
            ...
            <CardContent className="flex flex-col gap-3.5 px-3.5 pb-3.5">
              <div className="flex items-center justify-between gap-4">
                ...
                <Switch
                  ...
                  onCheckedChange={(c) =>
                    void saveSysSettings({ experimental_keep_screen_awake: c })
                  }
                />
              </div>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-3 px-3.5 pb-3.5">
              <div className="flex items-center justify-between">
