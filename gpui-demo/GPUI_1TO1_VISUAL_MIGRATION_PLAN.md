...
- ✅ Teams 第二批：列表筛选、新建、编辑、删除、复制/导入 JSON、人格/体系/楼层/星光/观测操作补齐 Enter/Space 激活与焦点环；编辑器标题、战斗、星光和反馈文案补齐中英文切换。
...
- ⏳ P2/P3/P4/P5/P6：全量 i18n、Home 描述/实际截图帧、Teams 剩余控件状态/资源细节、Settings/Help 键盘状态和全量视觉回归仍需继续；设置与 Teams Select 已支持弹出菜单、键盘和 Mock 持久化，离散队伍选择支持方向键，主题包权重 Slider 支持鼠标拖拽。
...
10. 完成 Teams 五个 Tab 的文案、主题、资源和全量键盘状态对齐。
11. 为 Home 补齐描述文案、真实截图帧占位/解码边界，并建立固定尺寸截图回归。
12. 逐页迁移其余页面，最后接入真实平台能力。
